...
| M3.7B | Watershed PRB evidence feasibility and model eligibility | Complete; published 2026-09-04 | None; local only |
| M3.7C | Deterministic PRB Funding Priority and tie methodology | Verification complete; checkpoint approval pending | None; local only |
| M3.7E | Cross-category evidence feasibility and model eligibility for the 106 analytical projects | Next | None unless separately authorized |
| M3.7D | Portfolio optimization methodology, including Watershed historical validation and later cross-category formulation | Deferred until M3.7E is resolved | None; local methodology work |
